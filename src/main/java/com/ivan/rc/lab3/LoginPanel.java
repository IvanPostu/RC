...
public class LoginPanel extends javax.swing.JPanel {
    ...
    public void addNotify() {
        ...
        requestThread = new Thread(() -> {
            ...
            if (Authentication.getInstance().isAuthenticated()) {
                JOptionPane.showMessageDialog(this.getParent(), "Autentificare a avut loc cu success", "Succes auth",
                        JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(this.getParent(), "Autentificare a avut loc cu eroare", "Error auth",
    ...
    private String preLoginRequest() {
        ...
        try (CloseableHttpClient client = HttpClients.createDefault();
                CloseableHttpResponse response = client.execute(endpoint)) {
            HttpEntity entity = response.getEntity();

            if (entity != null) {
                byte[] data = Utils.readAllBytes(entity.getContent());
    ...
    private void loginRequest(String username, String password, String preLoginCookie) {
        ...
        try (CloseableHttpClient httpclient = HttpClients.custom().build()) {
            ...
            HttpUriRequest request = RequestBuilder.post().setConfig(ConfigWithProxyFactory.getConfig())
                    .setEntity(stringEntity).setUri("http://club.chateg.ru/index.php")
                    .setHeader(HttpHeaders.CONTENT_TYPE, "application/x-www-form-urlencoded")
                    .setHeader("Cookie", String.format("PHPSESSID=%s", preLoginCookie)).build();
                    ...
                    for (Header h : headers) {
                        ...
                        if (h.getName().equals("Set-Cookie")) {
                            ...
                            if (Authentication.getInstance().getCookie().equals("")) {
                                Authentication.getInstance().setCookie(cooki);
                            } else {
                                Authentication.getInstance()
                                        .setCookie(Authentication.getInstance().getCookie() + "; " + cooki);
                            }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(jButton1, javax.swing.GroupLayout.PREFERRED_SIZE, 167,
                        ...
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(33, 33, 33)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(loginField).addComponent(passwordField,
                ...
                .addGroup(layout.createSequentialGroup().addGap(150, 150, 150)
                        ...
                        .addGroup(
                                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(jLabel2, javax.swing.GroupLayout.DEFAULT_SIZE, 44,
                                                Short.MAX_VALUE)
